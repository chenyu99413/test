...
class SharedStringsHelper
{
    ...
    protected function writeSharedStringToTempFile($sharedString, $sharedStringIndex)
    {
        ...
        fwrite($this->tempFilePointer, $sharedString . XLSX_EOL);
    }
    ...
    public function getStringAtIndex($sharedStringIndex)
    {
        ...
        if ($this->inMemoryTempFilePath !== $tempFilePath) {
            ...
            $this->inMemoryTempFileContents = explode(XLSX_EOL, file_get_contents($tempFilePath));
        ...
        return rtrim($sharedString, XLSX_EOL);
    }
