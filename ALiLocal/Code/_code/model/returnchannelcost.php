...
/**
 * 渠道成本
 * ReturnChannelCost 封装来自 tb_return_channel_cost 数据表的记录及领域逻辑
 */
class ReturnChannelCost extends QDB_ActiveRecord_Abstract {
	...
	static function __define() {
		return array (
			...
			// 用什么数据表保存对象
			'table_name' => 'tb_return_channel_cost',
	...
	/* ------------------ 以上是自动生成的代码，不能修改 ------------------ */
	//公式费用名称列表
	static function getFeename($customs_code){
...
class ReturnChannelCostException extends QException {}