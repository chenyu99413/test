...
/**
 * 黑名单
 * blacklist 封装来自 tb_blacklist 数据表的记录及领域逻辑
 */
class blacklist extends QDB_ActiveRecord_Abstract {
...
class blacklistException extends QException {}