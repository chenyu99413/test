...
class CodeTransport extends QDB_ActiveRecord_Abstract {
	/**
	 * 返回对象的定义
	 *
	 * @static
	...
	function _before_update(){
	    ...
	    if (!empty($changes)){
	        $log=new CodeTransportLog(array(
	            'code_id'=>$this->id,
...
class CodeTransportException extends QException {}