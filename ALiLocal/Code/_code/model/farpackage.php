...
/**
 * Farpackage 封装来自 tb_far_package 数据表的记录及领域逻辑
 */
class Farpackage extends QDB_ActiveRecord_Abstract {
...
class FarpackageException extends QException {}