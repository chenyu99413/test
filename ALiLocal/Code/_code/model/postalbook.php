...
/**
 * 邮政通讯录
 * postalbook 封装来自 tb_postalbook 数据表的记录及领域逻辑
 */
class postalbook extends QDB_ActiveRecord_Abstract {
...
class postalbookException extends QException {}