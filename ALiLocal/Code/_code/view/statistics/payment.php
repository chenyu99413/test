		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td colspan="3">
                        <a class="btn btn-info btn-small"href="javascript:void(0)" onclick="file()">
...
<div style="display: none">
	<form id="form" action="<?php echo url('statistics/compare')?>" method="post" enctype="multipart/form-data" style="display:none">
...
<div>
	...
	<div class="easyui-tabs" style="width: 1011px;" id="data-area">
...
function loadDeatil(href){
	...
	var url = "<?php echo url('statistics/PaymentDetail')?>";
...
function loadTotal(href){
	var $form = $('#page-top-search');
	var url = "<?php echo url('statistics/PaymentTotal')?>";
...
// 	var $form = $('#page-top-search');
	...
	$("#page-top-search").attr("action","<?php echo url('statistics/Paymentexport')?>");
	$("#page-top-search").submit();
	$("#page-top-search").attr("action","<?php echo url('statistics/Payment')?>");
}
$(function(){
