...
<table id="table_networkfuel" class="FarTable">
	...
	?>
<form id="formout" action="<?php echo url('channel/channelimportcode')?>" method="post" enctype="multipart/form-data" style="display:none">
...
function CallBack(obj,name){
	...
	$.ajax({
		url:"<?php echo url('channel/channelimportcodeadd')?>",
		type:"POST",
...
function DeleteBefore(obj){
	$.ajax({
		url:"<?php echo url('channel/DeleteZip')?>",
		type:"POST",
