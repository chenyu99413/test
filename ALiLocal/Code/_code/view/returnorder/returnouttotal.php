			...
			<tbody>
				<tr>
					...
					<td>
		               ...
		               <a class="btn btn-success btn-small" href="<?php echo url('/ReturnOut')?>" >
			             <i class="icon-plus"></i>
			                                         新建
		               </a>
			...
			<tr>
				...
				<td><?php if($temp->status == '0'):?>
				    ...
				    <a class="btn btn-mini "
				       href="<?php echo url('/ReturnOut',array('return_out_total_id' => $temp->return_out_total_id,'return_total_no'=>$temp->return_total_no,'type'=>$temp->type))?>">
				    <i class="icon-edit"></i>             
				                        继续扫描
				    </a>
				    <a class="btn btn-mini btn-danger" href="<?php echo url('/ReturnOutStatus', array('return_out_total_id' => $temp->return_out_total_id))?>">
                                                                        完成
				    </a>
				    <?php endif;?>
