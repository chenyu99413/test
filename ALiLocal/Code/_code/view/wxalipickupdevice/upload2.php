...
<div class="page__bd">
	<form action="<?php echo url('wxalipickupdevice/upload')?>" method="post">
		...
		<div class="weui-btn-area" style="text-align:center">
			...
			<a href="javascript:upload2();" style="width:100%" class="weui-btn  weui-btn_primary upload">微信拍照</a>
		</div>
...
//验证
  wx.config(<?php echo Helper_WX::jsConfig(array('scanQRCode','chooseImage'))?>);
  function scan(){
  	wx.scanQRCode({
	...
	function upload2(){
		wx.chooseImage({
	        ...
	        success: function (res) {
	            ...
	            $('.img_list2').append('<img src="'+res.localIds+'" />')
	        }
		})
	}
  wx.ready(function(){
