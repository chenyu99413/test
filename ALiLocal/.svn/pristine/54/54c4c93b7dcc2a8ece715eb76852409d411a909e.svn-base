...
/**
 * Orderproduct 封装来自 tb_order_product 数据表的记录及领域逻辑
 */
class Orderproduct extends QDB_ActiveRecord_Abstract {
...
class OrderproductException extends QException {}