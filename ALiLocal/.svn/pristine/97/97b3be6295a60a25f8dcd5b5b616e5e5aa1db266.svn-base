...
/**
 * Orderproduct 封装来自 tb_order_product_copy 数据表的记录及领域逻辑
 */
class OrderproductCopy extends QDB_ActiveRecord_Abstract {
	...
	static function __define() {
		return array (
			...
			// 用什么数据表保存对象
			'table_name' => 'tb_order_product_copy',
...
class OrderproductCopyException extends QException {}