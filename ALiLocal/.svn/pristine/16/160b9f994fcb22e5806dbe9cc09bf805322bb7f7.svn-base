...
<form method="post" onSubmit="return Check();">
	...
	<div class="tabs-panels">
		<div class="panel-body panel-body-noheader panel-body-noborder"
			...
			<div class="tabs-panels">
				<div class="panel-body panel-body-noheader panel-body-noborder" style="padding: -5px;">
						<?php echo Q::control("PartitionTabs", "tabs_partition_type", array ("tabs" => $tabs_partition,"active_id" => request("partition","1")))?>
						<div class="tabs-panels">
						<div class="panel-body panel-body-noheader panel-body-noborder"
							style="padding: 0px;">
								...
								<table id="table_price" class="FarTable" style="width: 100%;">
									<tbody>
										...
										<tr id="<?php echo $value->price_id?>">
											...
											<td width="100px;" ><?php echo $value->currency_code?></td>
											<td width="150px;">
												<a class="btn btn-mini" href="javascript:void(0);"
													onclick="EditRow([{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'6','min':'0'},{'type':'text','precision':'3','min':'0'},{'type':'select','option':<?php echo str_replace("\"","'",json_encode(CodeCurrency::getCurrencyList()));?>}],this);">
										...
										<tr>
											...
											<td width="150px;">
												<a class="btn btn-mini btn-success"
													...
													onclick="NewRow([{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'3','min':'0'},{'type':'number','precision':'6','min':'0'},{'type':'text','precision':'3','min':'0'},{'type':'select','option':<?php echo str_replace("\"","'",json_encode(CodeCurrency::getCurrencyList()));?>}],this);">
													<i class="icon-plus"></i>
													新建
												</a>
											</td>
		...
		$.ajax({
			...
			data:{"price_manage_id":"<?php echo request('price_manage_id')?>",
				"price":{
					...
					"currency_code":$(obj).children().eq(7).text()}},
			success:function(msg){
				if(msg == '币种不存在'){
					alert(msg)
				}else{
