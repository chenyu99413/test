...
class BarCode128 {
	...
	public function createBarCode($image_type ='png',$file_name=null)
	{
		...
		$fw = 10; //��̖��2��3�����w�Č��Ȟ�10����4��5�����w���Ȟ�11
		if ($this->font_type >3)
		{
			$sy++;
			$fw=11;
  ...
  if(isset($_REQUEST['height']) && $_REQUEST['height']>0){
     $barcode->height=(int)$_REQUEST['height'];
  }
  if(isset($_REQUEST['uwidth']) && $_REQUEST['uwidth']>0){
     $barcode->unit_width=$_REQUEST['uwidth'];
  }
