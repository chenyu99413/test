...
<ul class="tabs" style="height: 27px;">
 <li><a href="<?php echo url('/sign')?>" class="tabs-inner" style="height: 27px; line-height: 26.5333px;"><span class="tabs-title">有关联</span><span class="tabs-icon"></span></a></li>
 <li class="tabs-selected"><a class="tabs-inner" style="height: 27px; line-height: 26.5333px;"><span class="tabs-title">无关联</span><span class="tabs-icon"></span></a></li>
 </ul>
</div>
</div>
<form method="post">
	<div>
		<a class="btn btn-info btn-small" href="<?php echo url('/sign2',array('export'=>'export'))?>">
