			...
			<table>
				<tbody>
					<tr>
						...
						<th width=120 class="required-title">部门类型</th>
						<td>
							<?php
		                        echo Q::control ( 'dropdownbox', 'level', array (
		                        'items'=>array('1'=>'数据仓','2'=>'部门'),
		                        'empty'=>false,
		                        'style'=>'width:70px',
		                        'value' =>$department->level,
		                        ) )?>
						</td>
						<th width=120 class="required-title">业务类型</th>
						<td>
							<?php
		                        echo Q::control ( 'dropdownbox', 'status', array (
		                        'items'=>array('0'=>'内部仓','1'=>'外包仓'),
		                        'empty'=>false,
		                        'style'=>'width:70px',
