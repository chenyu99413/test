		...
		<table>
			<tbody>
				<tr>
					...
					<th>国家三字码</th>
					<td>
						<input type="text" name=code_word_three value="<?php echo request('code_word_three')?>"
							placeholder="精确查找" style="width: 150px;">
					</td>
					<td>
						...
						<button type="button" class="btn btn-small btn-success edit-modal"
							...
							data-url="<?php echo url('codecountry/editmodal')?>" data-w="500px"
							data-h="440px">
							<i class="icon-plus"></i>
							新建
						</button>
...
function getList(page, page_size) {
	var url = "<?php echo url('codecountry/list')?>";
