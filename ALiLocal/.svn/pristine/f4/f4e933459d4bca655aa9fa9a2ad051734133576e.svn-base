 ...
 */
class CaiNiao extends QDB_ActiveRecord_Abstract {
	
    
    static $s_cainiao=array(
    	'ARRIVE'=>'ARRIVE:抵达',
...
class CaiNiaoException extends QException {}