...
/**
 * 渠道
 * ReturnChannel 封装来自 tb_return_channel 数据表的记录及领域逻辑
 */
class ReturnChannel extends QDB_ActiveRecord_Abstract {
	static $method= array(
		'aliups'=>'上海UPS',
		'dhl'=>'DHL',
		'ems'=>'EMS',
...
class ReturnChannelException extends QException {}